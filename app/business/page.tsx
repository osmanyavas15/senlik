  ...
  const categories: FamilyCategory[] = [
    {
      ...
      name: 'Ev Bakımı',
      icon: '🏠',
      subCategories: ['Genel Temizlik', 'Derin Temizlik', 'Cam Silme', 'Ütü', 'Çamaşır', 'Bulaşık', 'Düzenleme', 'Dezenfeksiyon'],
    },
    {
      id: 'cocuk-bakim',
      name: 'Çocuk Bakımı',
      icon: '👶',
      subCategories: ['Bebek Bakıcısı', 'Çocuk Bakıcısı', 'Gündüz Bakımı', 'Gece Bakımı', 'Ödev Yardımı', 'Oyun Arkadaşı', 'Okul Servisi', 'Etkinlik'],
    },
    {
      id: 'yasli-bakim',
      name: 'Yaşlı Bakımı',
      icon: '👴',
      subCategories: ['Evde Bakım', 'Refakatçi', 'Hasta Bakımı', 'İlaç Takibi', 'Yemek Yardımı', 'Alışveriş', 'Doktor Randevu', 'Sosyal Aktivite'],
    },
    {
      id: 'yemek',
      name: 'Ev Yemeği',
      icon: '🍲',
      subCategories: ['Günlük Yemek', 'Haftalık Menü', 'Diyet Yemek', 'Bebek Maması', 'Davet Yemeği', 'Pasta Börek', 'Kahvaltı', 'Özel Gün'],
    },
    {
      id: 'bahce',
      name: 'Bahçe Bakımı',
      icon: '🌳',
      subCategories: ['Çim Biçme', 'Çiçek Bakımı', 'Ağaç Budama', 'Sulama', 'Gübreleme', 'Peyzaj', 'İlaçlama', 'Sebze Bahçesi'],
    },
    {
      id: 'evcil',
      name: 'Evcil Hayvan',
      icon: '🐾',
      subCategories: ['Köpek Gezdirme', 'Kedi Bakımı', 'Pet Sitting', 'Beslenme', 'Tımar', 'Veteriner', 'Eğitim', 'Pet Otel'],
    },
    {
      id: 'tamir',
      name: 'Ev Tamiri',
      icon: '🔧',
      subCategories: ['Musluk Tamiri', 'Priz Tamiri', 'Kapı Kilit', 'Menteşe', 'Raf Montaj', 'Perde Montaj', 'Ampul', 'Küçük Tamir'],
    },
    {
      id: 'organizasyon',
      name: 'Ev Organizasyonu',
      icon: '📦',
      subCategories: ['Dolap Düzeni', 'Mutfak Düzeni', 'Depo Düzeni', 'Garaj', 'Kiler', 'Çekmece', 'Kıyafet', 'Genel Düzen'],
    },
    {
      id: 'tasima',
      name: 'Ev Taşıma',
      icon: '🚚',
      subCategories: ['Ev Taşıma', 'Eşya Taşıma', 'Paketleme', 'Montaj Demontaj', 'Depolama', 'Asansör', 'Şehir İçi', 'Şehirlerarası'],
    },
    {
      id: 'ozel-ders',
      name: 'Özel Ders',
      icon: '📚',
      subCategories: ['Matematik', 'İngilizce', 'Fen', 'Türkçe', 'Müzik', 'Resim', 'Kodlama', 'Ödev Takibi'],
    },
    {
      id: 'saglik',
      name: 'Evde Sağlık',
      icon: '🏥',
      subCategories: ['Hemşire', 'Fizyoterapi', 'Enjeksiyon', 'Serum', 'Pansuman', 'Tansiyon', 'Şeker Ölçüm', 'Bakım'],
    },
    {
      id: 'guzellik',
      name: 'Evde Güzellik',
      icon: '💇',
      subCategories: ['Kuaför', 'Manikür Pedikür', 'Cilt Bakımı', 'Ağda', 'Makyaj', 'Masaj', 'Saç Boyama', 'Kaş Alma'],
    },
    {
      id: 'dekorasyon',
      name: 'Ev Dekorasyon',
      icon: '🎨',
      subCategories: ['İç Mimari', 'Renk Danışmanlığı', 'Mobilya Seçimi', 'Aydınlatma', 'Duvar Kağıdı', 'Perde', 'Aksesuar', 'Feng Shui'],
    },
    {
      id: 'boya',
      name: 'Boya Badana',
      icon: '🖌️',
      subCategories: ['İç Cephe', 'Dış Cephe', 'Tavan', 'Duvar', 'Kapı Pencere', 'Dekoratif', 'Alçı', 'Sıva'],
    },
    {
      id: 'temizlik-ozel',
      name: 'Özel Temizlik',
      icon: '✨',
      subCategories: ['Koltuk Yıkama', 'Halı Yıkama', 'Yorgan Yıkama', 'Perde Yıkama', 'Cam Cephe', 'İnşaat Sonrası', 'Buharlı', 'Antibakteriyel'],
    },
    {
      id: 'guvenlik',
      name: 'Ev Güvenliği',
      icon: '🔒',
      subCategories: ['Kamera', 'Alarm', 'Kapı Kilidi', 'Interkom', 'Kasa', 'Sensör', 'Akıllı Kilit', 'İzleme'],
    },
    {
      id: 'akilli-ev',
      name: 'Akıllı Ev',
      icon: '🏡',
      subCategories: ['Akıllı Aydınlatma', 'Termostat', 'Perde Otomasyon', 'Ses Sistemi', 'Kamera', 'Kapı Zili', 'Priz', 'Kurulum'],
    },
    {
      id: 'bocalar',
      name: 'İlaçlama',
      icon: '🐜',
      subCategories: ['Böcek İlaçlama', 'Fare', 'Hamam Böceği', 'Karınca', 'Kene', 'Güve', 'Örümcek', 'Genel İlaçlama'],
    },
    {
      id: 'nakliye-ozel',
      name: 'Özel Taşıma',
      icon: '📱',
      subCategories: ['Beyaz Eşya', 'Mobilya', 'Piyano', 'Kasa', 'Sanat Eseri', 'Hassas Eşya', 'Ofis', 'Tek Parça'],
    },
    {
      id: 'kisisel-asistan',
      name: 'Kişisel Asistan',
      icon: '👔',
      subCategories: ['Alışveriş', 'Fatura Ödeme', 'Randevu Alma', 'Kargo Takip', 'Resmi İşlemler', 'Rezervasyon', 'Organizasyon', 'Genel Yardım'],
    },
  ];
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-12 border-2 border-green-500 shadow-2xl">
              ...
              <p className="text-gray-300 mb-8 text-lg">
                Seçtiğiniz <span className="text-amber-400 font-bold">{selectedSubCategory}</span> hizmeti için
